...
$menu = array(
    ...
    'tce_logout.php' => array('link' => 'tce_logout.php', 'title' => $l['h_logout_link'], 'name' => "<i class='metismenu-icon pe-7s-power'></i> ".ucfirst($l['w_logout']), 'level' => 1, 'key' => '', 'enabled' => ($_SESSION['session_user_level'] > 0)),
