...
// echo '<span class="btn btn-alternate btn-block mt-3" onclick="$(\'#floatdiv\').toggle();$(\'#upload_mediafile_form\').show();$(\'#logoImg-cont\').show()">Upload Logo</span>'.K_NEWLINE;
...
<!--div id="floatdiv" style="padding:5%;display:none;position:fixed;width:100%;height:100%;left: 50%;top: 50%;transform: translate(-50%, -50%);z-index:99;background:#000000aa">
	<div class="position-relative m-3 p-3">
		<div class="delbtn position-absolute btn btn-danger" onclick="$('#floatdiv').toggle();getImg()">&times;</div>
