...
echo getFormRowTextInput('test_begin_time', $l['w_time_begin'], $l['w_time_begin'].' '.$l['w_datetime_format'], '', $test_begin_time, '', 19, false, false, 'datetime-local', '', false);
echo '</div>';
...
echo '<div class="col-md-4">';
echo getFormRowTextInput('test_end_time', $l['w_time_end'], $l['w_time_end'].' '.$l['w_datetime_format'], '', $test_end_time, '', 19, false, false, 'datetime-local', '', false);
echo '</div>';
echo '<div class="col-md-4">';
...
echo '</div>';
echo '<div class="col-md-6">';
echo getFormRowTextInput('test_score_wrong', $l['w_score_wrong'], $l['h_score_wrong'], '', $test_score_wrong, '^([0-9\+\-]*)([\.]?)([0-9]*)$', 20, false, false, false, '', true);
echo '</div>';
echo '</div>';
