...
if(f_sc_name('tmf_show_offline_sheet.php')){
	...
	echo '<div class="d-print-none app-page-title py-3 px-4 mb-3">'.K_NEWLINE;
	echo '<div class="page-title-wrapper">'.K_NEWLINE;
	echo '<div class="page-title-heading">'.K_NEWLINE;
	echo '<div class="page-title-icon">'.$page_icon.'</div><div>'.htmlspecialchars($thispage_title, ENT_NOQUOTES, $l['a_meta_charset']).K_NEWLINE;
